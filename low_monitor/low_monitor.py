...
TARGET_LAWS = [
    ...
    "特定化学物質の環境への排出量の把握等及び管理の改善の促進に関する法律", "特定化学物質の環境への排出量の把握等及び管理の改善の促進に関する法律施行令",
    "消防法", "消防法施行令", "消防法施行規則",  
    "外国為替及び外国貿易法", 
    ...
    "使用済自動車の再資源化等に関する法律", 
    "ポリ塩化ビフェニル廃棄物の適正な処理の推進に関する特別措置法", "ポリ塩化ビフェニル廃棄物の適正な処理の推進に関する特別措置法施行令", "ポリ塩化ビフェニル廃棄物の適正な処理の推進に関する特別措置法施行規則", 
