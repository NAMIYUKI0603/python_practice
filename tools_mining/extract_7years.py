...
TARGET_YEARS = {
    "R7": {"pdf": "input/防災白書R7.pdf", "pages": (18, 149)},
    "R6": {"pdf": "input/防災白書R6.pdf", "pages": (18, 164)}, # ★実際のファイル名に修正せよ
    "R5": {"pdf": "input/防災白書R5.pdf", "pages": (17, 150)}, # ★実際のファイル名に修正せよ
    "R4": {"pdf": "input/防災白書R4.pdf", "pages": (14, 134)}, # ★実際のファイル名に修正せよ
    "R3": {"pdf": "input/防災白書R3.pdf", "pages": (15, 138)}, # ★実際のファイル名に修正せよ
    "R2": {"pdf": "input/防災白書R2.pdf", "pages": (14, 134)}, # ★実際のファイル名に修正せよ
    "R1": {"pdf": "input/防災白書R1H30.pdf", "pages": (17, 144)}
}
