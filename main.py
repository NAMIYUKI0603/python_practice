...
# 抽象的な名詞、行政特有の言い回し
"基本的", "具体的", "積極的", "総合的", "様々", "これら", "それら",
"視点", "観点", "側面", "背景", "要因", "分野", "領域", "部門",
"課題", "問題", "事項", "項目", "内容", "結果", "成果", "影響",
"程度", "水準", "状態", "状況", "傾向", "全体", "部分", "中心",
# 行動を表すが、文脈がないと意味が薄いもの
"推進", "促進", "強化", "充実", "図る", "向上", "確保", "維持",
"達成", "実現", "展開", "実施", "実行", "検討", "対応", "措置",
"連携", "協力", "支援", "参加", "理解", "認識", "活動", "取組"
]
